...
<head>
    ...
    <%-- El CSS ahora vive en un archivo separado --%>
...
<aside class="sidebar">
    ...
    <div class="sidebar-bottom">
        ...
        <%-- La ruta usa contextPath para que funcione sin importar el context root --%>
...
<div class="main">
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            ...
            <div class="avatar" title="<%= u %>">
                <%
                    // Mostrar las 2 primeras letras del usuario como avatar
    ...
    <main class="content" id="content-area">
            ...
            <div class="panels">
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <a href="#" class="btn" onclick="return loadSection('facturas', null)">Ver todas</a>
                    </div>
                    <div class="panel-body">
                        <table>
                            <thead>
                                <tr>
                                    <th>Folio</th><th>Cliente</th><th>Total</th><th>Estado</th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <%-- ── Secciones vacías (se llenarán con datos del servidor) ── --%>
        <div id="section-clientes"       style="display:none"><div class="empty">Sección Clientes</div></div>
        <div id="section-facturas"       style="display:none"><div class="empty">Sección Facturas</div></div>
        <div id="section-empleados"      style="display:none"><div class="empty">Sección Empleados</div></div>
        <div id="section-nomina"         style="display:none"><div class="empty">Sección Nómina</div></div>
        <div id="section-polizas"        style="display:none"><div class="empty">Sección Pólizas</div></div>
        <div id="section-declaraciones"  style="display:none"><div class="empty">Sección Declaraciones</div></div>
        <div id="section-cuentas"        style="display:none"><div class="empty">Sección Catálogo de cuentas</div></div>
        <div id="section-config"         style="display:none"><div class="empty">Sección Configuración</div></div>
...
<script>
    ...
    function loadSection(id, el) {
        ...
        // Actualizar breadcrumb y botón de acción
        const cfg = labels[id] || {};
        ...
        currentSection = id;
        return false; // prevenir navegación del href="#"
    }
